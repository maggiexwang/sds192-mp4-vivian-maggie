...
Graph 3. Genres of the long films.    

Graph 3 above shows that among the insanely long movies, more of them are dramas, biographies, or adventures. This probably match your viewing experience as an audience: dramas adapted from novels or drawn from epic wars, like *Gone with the Wind* and *Gettysburg*, do require a fair amount of time to get through, while a biography compressing someone’s life story would be understandably long. For adventures, the *Lord of the Rings* series speaks for itself: *The Return of the King*, the last film of the original 3-film series, runs for a jaw-dropping length of 263 minutes and scores 8.9 on IMDb.  
