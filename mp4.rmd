...
Graphic 2 shows how average ratings of movies change as lengths increase, with diamond size indicating how many films are of that length. For example, there are 1421 movies that are between 2 and 2.5 hours; their average rating is around 7.0. Most movies run for 1.5 to 2 hours, and have a mediocre average rating around 6.4. So, takeaway for aspiring filmmakers: consider the long-run, literally.  
