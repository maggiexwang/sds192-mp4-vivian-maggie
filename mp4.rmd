...
The first task is demystifying the accusations around increasing movie length here in the U.S. In graphic above, the length of all the movies released in each year are averaged out and displayed against a time scale running from the glamourous 1920s to modern Hollywood. Besides the sharp uptick around 1925 when the [Golden Age of Hollywood](http://www.filmsite.org/20sintro.html) popularized long feature films, average film length seems to have generally remained between 1.5 and 2 hours throughout the years. In other words, movie lengths haven’t been significantly extended over the decades.   

So do millennials lose this match point? Not quite. Though Graphic 1 shows average length staying within 1.5 to 2 hours, there are clearly slight ups-and-downs from decade to decade. When the [millennial generation](https://www.huffingtonpost.com/christine-henseler/millennials-and-boomers-generation-x_b_5253931.html) (born 1985-2000) was filling theater seats, runtime averages were indeed on the rise. From their perspective, they aren’t wrong in arguing that movies have gotten longer. Conversely, to the [Generation Xers](https://www.huffingtonpost.com/christine-henseler/millennials-and-boomers-generation-x_b_5253931.html) (born 1965-1985) insisting millennials whine too much, this first graphic provides a reminder that the victory of and adherence to 2-hour VHS tapes in the [videotape format war](https://en.wikipedia.org/wiki/Videotape_format_war) of the 70s slashed an average of 10 minutes off your childhood movies. There’s no clear winner here; we’re all justified.   

The period from 1930 to 1960 also exhibits an upward trend peaking around 1960 at 2 hours. The [rise of television](http://www.encyclopedia.com/arts/culture-magazines/hollywood-and-television-1950s-roots-diversification) in the 30s forced movie producers to compete by releasing epic films that extended runtimes by an average of around 30 minutes through the 60s. Nowadays, TV and online streaming don’t appear to threaten movie studios as much as it used to. From 2000 onwards, runtimes stagnated at around 1.7 hours.  

Then are we really whining about long movies? Recall the last time you sat through a 3 hour movie - did you walk out of the theater complaining about having to pee or about how tedious the film was? Data shows that your hours of suffering were likely worth it - longer films are actually rated higher.  
...
This graphic above shows how average ratings of movies change as lengths increase, with diamond size indicating how many films are of that binned length. For example, there are 1421 movies that are between 2 and 2.5 hours; their average rating is around 7.0. Most movies run for 1.5 to 2 hours, and have a mediocre average rating around 6.4. So, takeaway for aspiring filmmakers: consider the long-run, literally.  
...
Alternatively, it could also be argued that only people who are already invested enough in the specific topic of a 3-hour long film are going to sit through it, of course they’re going to rate it higher. While there are big names in the table of highest-rated 3+ hour films below, it’s safe to say that not everyone is jumping to sit through an adaptation of Tolstoy’s [*War and Peace*](http://www.imdb.com/title/tt0049934/) or a detailed biopic like [*Gandhi*](http://www.imdb.com/title/tt0083987/?ref_=fn_al_tt_1). Films like these are to some extent niche in their appeal; if you sat through it in the first place, you either had some commitment to the content or you straight up fell asleep. No judgment either way.  
