...
As they [battle for profits](http://bgr.com/2015/01/02/netflix-vs-movie-theaters/) with entertainment competitors such as Netflix and YouTube, production studios and other movie industry players have high stakes in understanding audience preferences. Luckily, with the advent of the Internet, we now have the means to address these questions with the runtimes and ratings within the [International Movie Database (IMDb)](http://www.imdb.com/). The data reveals not only film length patterns that reflect the history of entertainment technology, but also that we take a page from Rhett when it comes to enjoying long movies: frankly, we don’t give a damn.
...
The first task of the day is demystifying the accusations around increasing movie length here in the U.S. In graphic above, the length of all the movies released in each year are averaged out and displayed against a time scale running from the old glamour of the 1920s to modern Hollywood productions. Besides the sharp uptick around 1925 when the [Golden Age of Hollywood](http://www.filmsite.org/20sintro.html) popularized long feature films, average film length seems to have generally remained between 1.5 and 2 hours throughout the years. In other words, movie lengths haven’t been significantly extended over the decades.   

So do millennials lose this match point? Not quite. Though Graphic 1 shows average length predominantly staying within the 1.5 to 2 hour threshold, there are clearly slight ups-and-downs from decade to decade. When the [millennial generation](https://www.huffingtonpost.com/christine-henseler/millennials-and-boomers-generation-x_b_5253931.html) was arriving on scene (born 1985-2000) and filling theater seats, runtime averages were indeed on the rise. From their perspective, they aren’t wrong in arguing that movies have gotten longer. Conversely, to the [Generation Xers](https://www.huffingtonpost.com/christine-henseler/millennials-and-boomers-generation-x_b_5253931.html) (born 1965-1985) insisting that millennials whine too much, this first graphic provides a reminder that the victory of and subsequent adherence to 2-hour VHS tapes in the [videotape format war](https://en.wikipedia.org/wiki/Videotape_format_war) of the 70s slashed an average of 10 minutes off your childhood movies. There’s no clear winner here; we’re all justified from our own time perspectives.   

Apart from the ongoing Generation X v. Millennials showdown, the period from 1930 to 1960 also exhibits an interesting upward trend with a peak around 1960 at 2 hours. The [rise of television](http://www.encyclopedia.com/arts/culture-magazines/hollywood-and-television-1950s-roots-diversification) in the 30s forced movie producers to compete by releasing more epic films that extended runtimes by an average of around 30 minutes through the 60s. Nowadays, television’s reincarnation into streaming such as Netflix doesn’t appear to threaten movie studios as much as it used to. From 2000 onwards, Graphic 1 shows a stagnation of average runtimes at around 1.7 hours.  
...
This graphic above shows how the average ratings of movies change as their lengths increase, with the size of the diamonds indicating how many films are of that binned length. For example, there are 1421 movies that are longer than 2 hours but shorter than 2 hours 30 minutes, and their average rating is around 7.0. Most movies run for 90-120 minutes, and have a mediocre average rating around 6.4. So, some takeaway for aspiring young filmmakers: consider the long-run, literally.  

One possible explanation for this phenomenon stems from directors and their reputations for producing standout films. When a new director hits the scene (pun intended), they have little credibility. Business-savvy production studios and investors are unlikely to trust newbies who haven’t proven their commercial appeal with extensive budgets. Without backing, longer movies are financially unattainable. Pulling in profits allows directors to win themselves the higher budgets, expansive resources, and creative freedom to produce longer movies. Whether those dollars are brought in by a director’s visionary talent or their ability to capitalize on shock value, their presence indicates audience approval and higher ratings. In other words, longer movies land higher ratings because only directors who have shown that they can attract audiences are trusted to produce them.   

Take Scorcese and Tarantino for example. Both are legends in their own respects: Scorcese for hard-hitting films that defined his generation ([*Goodfellas*](http://www.imdb.com/title/tt0099685/) ring a bell?) and Tarantino for trademark violence and profanity. Both are also producing longer films than they used to, fame raking in bigger budgets to work with. The third graphic below shows how Scorcese and Tarantino have edged away from average movie runtimes over the years as their films push closer to 2.5, almost 3 hours. Scorcese hasn’t directed a movie under 2 hours since his 1985 [*After Hours*](https://www.theatlantic.com/entertainment/archive/2013/12/all-the-scorsese-movies-that-could-have-been-longer-than-wolf-of-wall-street/356335/); Tarantino has pushed closer to 3 hours since his 2015 [*The Hateful Eight*](https://www.cinemablend.com/new/Hateful-Eight-About-Three-Hours-Long-Too-Long-Or-Just-Right-93487.html). Yet, their increasing runtimes haven’t deterred them from scoring high ratings. In fact, moviegoers have consistently ranked their longer films in the range of 7 to 9, well above the average of 6.4 for movies that only run for 1.5 to 2 hours. For audiences, Scorcese and Tarantino’s abilities to deliver quality entertainment in their films seem to outweigh the cost of the 3-hour time commitment. 
...
Alternatively, it could also be argued that only people who are already invested enough in the specific topic of a 3-hour long film are going to sit through it, of course they’re going to rate it higher. While there are big names in the table of highest-rated 3+ hour films included below, it’s probably safe to say that not everyone is jumping to sit through an adaptation of Tolstoy’s [*War and Peace*](http://www.imdb.com/title/tt0049934/) or a detailed biopic like [*Gandhi*](http://www.imdb.com/title/tt0083987/?ref_=fn_al_tt_1). Films like these are to some extent niche in their appeal; if you sat through it in the first place, you either had some commitment to the content or you straight up fell asleep. No judgment either way.  
